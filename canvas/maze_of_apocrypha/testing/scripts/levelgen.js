	...
	if(map[midTile][midTile] == 23)
	{
		...
		if(keyDir == 0)
		{
			...
			if(Math.floor(Math.random()*2))
			{
				...
				monsterVX = monspd; monsterVY = 0; monsterTime = monsterglimpsduration;
		...
		else if(keyDir == 90)
		{
			...
			if(Math.floor(Math.random()*2))
			{
				...
				monsterVX = 0; monsterVY = monspd; monsterTime = monsterglimpsduration;
